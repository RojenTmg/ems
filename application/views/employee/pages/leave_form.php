        ...
        <form class="form" action="<?= site_url('employee/leave_form'); ?>" method="POST" id="form-leave-request">
          ...
          <div class="sp-btn leave-date">
            ...
            <div class="form-div">
              ...
              <input type="text" name="" disabled="disabled" class="<?php if (isset($not_valid) || isset($not_valid_inject)) echo "remDurationError"; ?>" value="<?php if(isset($leave_form['from_date']) && isset($leave_form['to_date'])) { echo (round((strtotime($leave_form['to_date']) - strtotime($leave_form['from_date'])) / 86400) + 1); } elseif (isset($leave_form['duration_type']) && $leave_form['duration_type'] == 'full') { echo '1'; } else { echo '1/2'; } ?>" id="duration">
            </div>
          </div>
          <div class="form-div">
