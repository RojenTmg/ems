...
<head>
  <title>Database Error</title>
      <?= link_tag('assets/css/error404.css') ?>
...
<main>
 <svg
  ...
  <p id="errorText">The page you are looking for could not be found due to database error. <br> Please Contact the Administrator.</p>
