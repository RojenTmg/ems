    ...
    <div class="tab-content" id="nav-tabContent">
      <div class="tab-pane fade show active" id="nav-general" role="tabpanel" aria-labelledby="nav-general-tab">
        <form class="form" id="general-form">
          <div class="form-div">
            <label>Title</label>
            <select disabled="true" name="title" id="title">
          ...
          <div class="form-div">
            ...
            <input type="text" disabled="true" value="<?php if(isset($firstname)) echo $firstname;?>" id="firstname" placeholder="" >
          </div>
          <div class="form-div">
            <label>Middle Name  <span class="opt"><i>(Optional)</i></span></label>
            <input type="text" disabled="true"  value="<?php if(isset($middlename)) echo $middlename;?>" id="middlename" placeholder="">
          </div>
          <div class="form-div">
            <label>Sur Name<span class="text-danger"><i>*</i></span></label>
            <input type="text" disabled="true" value="<?php if(isset($surname)) echo $surname;?>" id="surname" placeholder="">
          </div>
      ...
      <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
        <form class="form" id="contact-form">
          <div class="form-div">
            ...
            <input type="text" value="<?php if(isset($permanentaddress)) echo $permanentaddress;?>" placeholder="" id="permanentaddress">
          </div>
          <div class="form-div">
            <label>Current Address</label>
            <input type="text" id="currentaddress" value="<?php if(isset($currentaddress)) echo $currentaddress;?>" placeholder="">
          </div>
          <div class="form-div">
          ...
          <div class="form-div">
            ...
            <input type="number" value="<?php if(isset($contact)) echo $contact;?>" id="contact" placeholder="">
          </div>
          <div class="form-div">
            <label>Email Address</label>
            <input type="email" value="<?php if(isset($email)) echo $email;?>" id="email" placeholder="">
          </div>
          <div class="sub-can">
      ...
      <div class="tab-pane fade" id="nav-nationality" role="tabpanel" aria-labelledby="nav-nationality-tab">
        <form name="nationality-tab" id="nationality-form" class="form">
          <div class="form-div">
            ...
            <div>
              <div>
                <input type="radio" name="nationality" <?php if(isset($nationality)&&$nationality=='nepalese') echo 'checked="true"' ;?> value="nepalese">
                <label>Nepalese</label>
              </div>
              <div>
                <input type="radio" name="nationality" <?php if(isset($nationality)&&$nationality=='non-nepalese') echo 'checked="true"' ;?> value="non-nepalese">
          ...
          <div class="form-div">
            ...
            <div>
              <input type="radio" name="permission" <?php if(isset($permission)&&$permission=='yes') echo 'checked="true"' ;?> value="yes">
              <label>Yes</label>
            </div>
            <div>
              <input type="radio" name="permission" <?php if(isset($permission)&&$permission=='no') echo 'checked="true"' ;?> value="no">
              <label>No</label>
            </div>
          </div>
          <div class="form-div">
            <label>If yes, please specify your visa type and visa end date </label>
            <input type="text" id="visatype" value="<?php if(isset($visatype)) echo $visatype;?>"  placeholder="">
          </div>
          <div class="form-div">
            <label>Citizenship/Passport No. and Place of Issue</label>
            <input type="number" id="passport" value="<?php if(isset($passport)) echo $passport;?>" placeholder="">
          </div>
          <div class="sub-can">
      ...
      <div class="tab-pane fade show" id="nav-eContact" role="tabpanel" aria-labelledby="nav-eContact-tab">
        <form class="form" id="emergency-form">
          <div class="form-div">
            <label>Name</label>
            <input type="text" id="cpname" value="<?php if(isset($cpname)) echo $cpname;?>" placeholder="">
          </div>
           <div class="form-div">
            <label>Address</label>
            <input type="text" id="cpaddress" value="<?php if(isset($cpaddress)) echo $cpaddress;?>" placeholder="">
          </div>
           <div class="form-div">
            <label>Phone No.</label>
            <input type="number" id="cpcontact" value="<?php if(isset($cpcontact)) echo $cpcontact;?>" placeholder="">
          </div>
          <div class="sub-can">
      ...
      <div class="tab-pane fade" id="nav-education" role="tabpanel" aria-labelledby="nav-education-tab">
        <form class="form" id="education-form">
          <div class="form-div" >
            ...
            <input type="text" id="highestdegree" value="<?php if(isset($highestdegree)) echo $highestdegree;?>" placeholder="">
          </div>
          <div class="form-div">
            <label>Previous Employer</label>
            <input type="text" id="previousemployer" value="<?php if(isset($previousemployer)) echo $previousemployer;?>" placeholder="">
          </div>
          <div class="sub-can">
      ...
      <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-health-tab">
         <form class="form" id="health-form">
           <div class="form-div">
            ...
            <input type="text" id="bloodgroup" value="<?php if(isset($bloodgroup)) echo $bloodgroup;?>"  placeholder="">
          </div>
          <div class="form-div">
            <label>Medical Complications  <span class="opt"><i>(If any)</i></span></label>
            <input type="text" id="medicalcomplications" value="<?php if(isset($medicalcomplications)) echo $medicalcomplications;?>" placeholder="">
          </div>
          <div class="form-div">
            <label>Regular Medication  <span class="opt"><i>(If any)</i></span></label>
            <input type="text" id="regularmedication" value="<?php if(isset($regularmedication)) echo $regularmedication;?>" placeholder="">
          </div>
          <div class="form-div">
          ...
          <div class="form-div">
            ...
            <input type="text" id="others" value="<?php if(isset($others)) echo $others;?>" placeholder="">
          </div>
          <div class="sub-can">
      ...
      <div class="tab-pane fade" id="nav-pan" role="tabpanel" aria-labelledby="nav-pan-tab">
        <form class="form" id="pan-form">
          <div class="form-div">
            ...
            <input type="number" id="pan" value="<?php if(isset($pan)) echo $pan;?>" placeholder="">
          </div>
          <div class="sub-can">
