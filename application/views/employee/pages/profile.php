<div class="contents">
	<div class="emp-detail">
		<a class="float-right" href="<?= site_url('employee'); ?>" id="small-link"> <i class="fa fa-long-arrow-left" aria-hidden="true"></i> &nbsp;Go back to Dashboard</a>
		<div class="detail-head">
			...
			<div class="head-name">
				...
				<!-- edit profile -->
				 <a href="<?= base_url('employee'); ?>/profile_update/<?php echo $_SESSION['user_id'];?>">Edit Profile</a>
		</div>
