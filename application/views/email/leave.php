        ...
        <table class="table table-bordered table-hover"  >
          <thead class="thead-dark">
            <tr>
              ...
              <th id="dt-head" style="width: 1%;"><div class="sp-btn"><span>Duration(days)</span><i class="fa fa-sort" aria-hidden="true"></i></div></th>
          ...
          <tbody>
            <?php
                foreach ($employee_leaves_all as $value) { 
                  $today = Date('Y-m-d');
                  if($value['to_date']=='') $value['to_date']=$value['from_date'];
                  if($today>=$value['from_date'] && $today<=$value['to_date']){
                  ?>
                  <tr>
